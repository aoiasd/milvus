...
type RootCoordCatalog interface {
	...
	DropRLSPolicy(ctx context.Context, dbID int64, collectionID int64, policyName string) error
	...
	GetRLSPrincipal(ctx context.Context, dbID int64, collectionID int64, principalName string) (*model.RLSPrincipal, error)
	DropRLSPrincipal(ctx context.Context, dbID int64, collectionID int64, principalName string) error
	ListRLSPrincipals(ctx context.Context, dbID int64, collectionID int64) ([]*model.RLSPrincipal, error)
