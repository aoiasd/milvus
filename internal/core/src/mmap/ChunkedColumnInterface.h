...
class ChunkedColumnInterface {
 public:
    using RowIdScanBatch = milvus::RowIdScanBatch;
    using RowIdScanCursor = milvus::RowIdScanCursor;
    ...
    using DataScanBatch = milvus::DataScanBatch;
    using DataScanCursor = milvus::DataScanCursor;
...
#include "mmap/ChunkedColumnScanCursors.h"
