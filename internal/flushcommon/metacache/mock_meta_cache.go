...
func (_m *MockMetaCache) AddSegment(segInfo *datapb.SegmentInfo, pkFactory PkStatsFactory, bmFactory BmStatsFactory, actions ...SegmentAction) {
...
func (_c *MockMetaCache_AddSegment_Call) Run(run func(segInfo *datapb.SegmentInfo, pkFactory PkStatsFactory, bmFactory BmStatsFactory, actions ...SegmentAction)) *MockMetaCache_AddSegment_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		run(args[0].(*datapb.SegmentInfo), args[1].(PkStatsFactory), args[2].(BmStatsFactory), variadicArgs...)
	})
	return _c
}
...
func (_c *MockMetaCache_AddSegment_Call) RunAndReturn(run func(*datapb.SegmentInfo, PkStatsFactory, BmStatsFactory, ...SegmentAction)) *MockMetaCache_AddSegment_Call {
	_c.Call.Return(run)
	return _c
}
